...
from monai.networks.nets import resnet18, densenet121, ShuffleNetV2, ViT
...
def get_model(model_type):
    if model_type == 'resnet':
        ...
        return ShuffleNetV2(spatial_dims=3, in_channels=1, num_classes=2)
    elif model_type == 'transformer':
        return ViT(spatial_dims=3, in_channels=1, img_size=(64,64,64), patch_size=16, num_classes=2)  # img_size需根据实际数据调整
    else:
