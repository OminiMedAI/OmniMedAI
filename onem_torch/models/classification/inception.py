...
def inception_v3(pretrained=False, progress=True, transfer_learning=True, aux_logits=True, transform_input=True,
                 **kwargs):
    r"""Inception v3 core architecture from
    ...
    original_aux_logits = aux_logits
    ...
    if pretrained:
        ...
        for k in parameters_list:
            if (k.startswith('AuxLogits.') or k.startswith('fc.')) and transfer_learning:
                del state_dict[k]
